...
app = Flask(__name__)
server_ip = "http://192.168.77.94:4000"
@app.route("/")
def home():
...
def thingspeakrainfall():
    ...
    url = "https://thingspeak.com/channels/1324552/field/1.json?result=20"
...
def thingspeaksmoke():
    headers = {'Accept': 'application/json'}
    url = "https://thingspeak.com/channels/1324552/field/2.json?result=20"
    r = requests.get(url, headers=headers)
    return r.json()
